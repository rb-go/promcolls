...
func TestProcessCollector(t *testing.T) {
	...
	if err := registry.Register(NewCollector(ProcessCollectorOpts{})); err != nil {
		t.Fatal(err)
	}
	if err := registry.Register(NewCollector(ProcessCollectorOpts{
	...
	brokenProcessCollector := NewCollector(ProcessCollectorOpts{
