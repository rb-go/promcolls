...
// 				switch v := v.(type) {
// 				case float64:
// 					m = prometheus.MustNewConstMetric(desc, prometheus.UntypedValue, v, copiedLabels...)
// 				case bool:
// 					if v {
// 						m = prometheus.MustNewConstMetric(desc, prometheus.UntypedValue, 1, copiedLabels...)
// 					} else {
// 						m = prometheus.MustNewConstMetric(desc, prometheus.UntypedValue, 0, copiedLabels...)
// 					}
// 				default:
// 					return
// 				}
